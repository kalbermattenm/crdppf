            ...
            <tr valign="top" >
              <td align="left" valign="top">
                <span class="banner1">&nbsp;
                    ...
                    <a class="banner2" href="http://geo.jura.ch/doc/MapFish/CRDPPF_Extrait_certifie.pdf" target="_blank">Commande extrait certifié</a> -
                    <a class="banner2" href="http://geo.jura.ch" target="_blank">GéoPortail</a> -
                    <a class="banner2" href="http://geo.jura.ch/doc/MapFish/Aide_CRDPPF.pdf" target="_blank">Aide</a> -
